...
/// @brief Component to store map preview texture for UI rendering
struct MapPreviewTexture : BaseComponent {
  raylib::Texture2D texture;
  
  MapPreviewTexture() = default;
  MapPreviewTexture(const raylib::Texture2D& tex) : texture(tex) {}
};
