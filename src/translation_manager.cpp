...
LanguageMap create_translation_data() {
  ...
  TranslationMap english_translations = {
      ...
      {strings::i18n::about,
       TranslatableString("HOW TO PLAY",
                          "Main menu button to show game information")},
      {strings::i18n::exit,
       TranslatableString("QUIT", "Main menu button to quit the game")},
      ...
      {strings::i18n::settings,
       TranslatableString("OPTIONS",
                          "Main menu button to access game settings")},
      {strings::i18n::volume,
       TranslatableString("volume", "Generic volume setting label")},
      {strings::i18n::fullscreen,
       TranslatableString("FULLSCREEN", "Options row label: fullscreen toggle")},
      {strings::i18n::resolution,
       TranslatableString("SIZE", "Options row label: screen resolution")},
      {strings::i18n::language,
       TranslatableString("LANGUAGE", "Options row label: game language")},
      ...
      {strings::i18n::round_length,
       TranslatableString("CLOCK",
                          "Round settings row label for the round timer")},
      {strings::i18n::allow_tag_backs,
       TranslatableString("TAG BACKS",
                          "Round settings row label: allow immediate tag backs")},
      {strings::i18n::select_map,
       TranslatableString("PICK A TRACK",
                          "Button to choose a map for the game")},
      {strings::i18n::master_volume,
       TranslatableString("MASTER", "Options row label: overall game volume")},
      {strings::i18n::music_volume,
       TranslatableString("MUSIC", "Options row label: background music volume")},
      {strings::i18n::sfx_volume,
       TranslatableString("EFFECTS", "Options row label: sound effects volume")},
      {strings::i18n::post_processing,
       TranslatableString("FILTER",
                          "Options row label: visual post-processing toggle")},
      ...
      {strings::i18n::time_10_seconds,
       TranslatableString("10 SECONDS", "Round length option: ten seconds")},
      {strings::i18n::time_30_seconds,
       TranslatableString("30 SECONDS", "Round length option: thirty seconds")},
      {strings::i18n::time_1_minute,
       TranslatableString("1 MINUTE", "Round length option: one minute")},
      {strings::i18n::round_type_lives,
       TranslatableString("SURVIVAL", "Round type: last kart alive wins")},
      {strings::i18n::round_type_kills,
       TranslatableString("MOST KILLS", "Round type: most kills wins")},
      {strings::i18n::round_type_hippo,
       TranslatableString("HIPPO GRAB", "Round type: collect the most pickups")},
      {strings::i18n::round_type_tag,
       TranslatableString("TAG", "Round type: avoid being 'it'")},
      {strings::i18n::weapon_cannon,
       TranslatableString("CANNON", "Weapon name")},
      {strings::i18n::weapon_shotgun,
       TranslatableString("SHOTGUN", "Weapon name")},
      {strings::i18n::weapon_sniper,
       TranslatableString("SNIPER", "Weapon name")},
      {strings::i18n::weapon_machine_gun,
       TranslatableString("MACHINE GUN", "Weapon name")},
      {strings::i18n::easy,
  ...
  TranslationMap korean_translations = {
      ...
      {strings::i18n::master_volume,
       TranslatableString("마스터 볼륨",
                          "전체 게임 볼륨을 위한 슬라이더")},
      {strings::i18n::music_volume,
       TranslatableString("음악 볼륨",
                          "배경 음악 볼륨을 위한 슬라이더")},
      {strings::i18n::sfx_volume,
       TranslatableString("효과음 볼륨",
                          "효과음 볼륨을 위한 슬라이더")},
      {strings::i18n::post_processing,
       TranslatableString("후처리",
                          "시각적 후처리 효과를 활성화하는 체크박스")},
      {strings::i18n::round_end,
       TranslatableString("라운드 종료",
                          "라운드가 끝날 때 표시되는 제목")},
      {strings::i18n::paused,
      ...
      {strings::i18n::time_10_seconds,
       TranslatableString("10초", "라운드 길이 옵션: 10초")},
      {strings::i18n::time_30_seconds,
       TranslatableString("30초", "라운드 길이 옵션: 30초")},
      {strings::i18n::time_1_minute,
       TranslatableString("1분", "라운드 길이 옵션: 1분")},
      {strings::i18n::round_type_lives,
       TranslatableString("생존", "라운드 종류: 마지막까지 살아남기")},
      {strings::i18n::round_type_kills,
       TranslatableString("최다 처치", "라운드 종류: 가장 많이 처치하기")},
      {strings::i18n::round_type_hippo,
       TranslatableString("하마 모으기", "라운드 종류: 하마를 가장 많이 모으기")},
      {strings::i18n::round_type_tag,
       TranslatableString("술래잡기", "라운드 종류: 술래가 되지 않기")},
      {strings::i18n::weapon_cannon,
       TranslatableString("대포", "무기 이름")},
      {strings::i18n::weapon_shotgun,
       TranslatableString("산탄총", "무기 이름")},
      {strings::i18n::weapon_sniper,
       TranslatableString("저격총", "무기 이름")},
      {strings::i18n::weapon_machine_gun,
       TranslatableString("기관총", "무기 이름")},
      {strings::i18n::easy,
  ...
  TranslationMap japanese_translations = {
      ...
      // Japanese "seconds" is 秒. The Korean 초 belongs in the Korean table
      // only -- it has been pasted into this row before.
      {strings::i18n::time_10_seconds,
       TranslatableString("10秒", "ラウンド長のオプション: 10秒")},
      {strings::i18n::time_30_seconds,
       TranslatableString("30秒", "ラウンド長のオプション: 30秒")},
      {strings::i18n::time_1_minute,
       TranslatableString("1分", "ラウンド長のオプション: 1分")},
      {strings::i18n::round_type_lives,
       TranslatableString("サバイバル", "ラウンド種別: 最後まで生き残る")},
      {strings::i18n::round_type_kills,
       TranslatableString("キル数", "ラウンド種別: 一番多く倒す")},
      {strings::i18n::round_type_hippo,
       TranslatableString("カバ集め", "ラウンド種別: カバを一番多く集める")},
      {strings::i18n::round_type_tag,
       TranslatableString("おにごっこ", "ラウンド種別: おにになるな")},
      {strings::i18n::weapon_cannon,
       TranslatableString("大砲", "武器名")},
      {strings::i18n::weapon_shotgun,
       TranslatableString("ショットガン", "武器名")},
      {strings::i18n::weapon_sniper,
       TranslatableString("スナイパー", "武器名")},
      {strings::i18n::weapon_machine_gun,
       TranslatableString("マシンガン", "武器名")},
      {strings::i18n::easy,
