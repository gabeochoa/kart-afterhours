"""
Module extension to declare external repositories previously in WORKSPACE.
"""

load("@bazel_tools//tools/build_defs/repo:http.bzl", "http_archive")

def _kart_afterhours_deps_impl(module_ctx):
    # raylib
    http_archive(
        name = "raylib",
...
kart_afterhours_deps = module_extension(implementation = _kart_afterhours_deps_impl)
